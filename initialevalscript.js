function generatePDF() {
    ...
    if (shouldercheckbox.checked) {
        ...
        if (rightverticalposition >= leftverticalposition) {
            ...
            doc.line(20, verticalposition + 7, 190, verticalposition + 7);
            verticalposition += 15;
        }
        ...
        if (hasUserInput(shoulderobservation)) {
            ...
            var shoulderpalpationwidth = doc.getTextWidth(shoulderobservation);
            doc.setFont("courier", "normal");
        ...
        if (hasUserInput(shouldermobility)) {
            ...
            doc.setFont("courier", "normal");
            doc.text(shouldermobility, labelwidth + 20, verticalposition);
            doc.line(20, verticalposition + 5, 190, verticalposition + 5);
            verticalposition += 10;
        }
        ...
        if (hasUserInput(shoulderspecialtests)) {
            ...
            doc.text(shoulderspecialtests, labelwidth + 20, verticalposition);
            doc.line(20, verticalposition + 5, 190, verticalposition + 5);
            verticalposition += 10;
        }
